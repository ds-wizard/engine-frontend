module KMEditor.Editor2.View.Breadcrumbs exposing (breadcrumbs)
...
import KMEditor.Editor2.Models.Editors exposing (Editor, getEditorPath, getEditorTitle)
import KMEditor.Editor2.Msgs exposing (Msg(SetActiveEditor))
