module KMEditor.Editor2.KMEditor.View exposing (view)
...
import KMEditor.Editor2.KMEditor.View.Breadcrumbs exposing (breadcrumbs)
import KMEditor.Editor2.KMEditor.View.Editors exposing (activeEditor)
import KMEditor.Editor2.KMEditor.View.Tree exposing (treeView)
