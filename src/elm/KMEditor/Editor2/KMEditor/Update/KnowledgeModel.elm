module KMEditor.Editor2.KMEditor.Update.KnowledgeModel exposing
    ( addChapter
    , addTag
    , updateKMForm
...
import KMEditor.Editor2.KMEditor.Models.Forms exposing (knowledgeModelFormValidation)
import KMEditor.Editor2.KMEditor.Update.Abstract exposing (addEntity, updateForm, withGenerateEvent)
import KMEditor.Editor2.KMEditor.Update.Events exposing (createEditKnowledgeModelEvent)
import Msgs
