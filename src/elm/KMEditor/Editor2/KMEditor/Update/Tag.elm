module KMEditor.Editor2.KMEditor.Update.Tag exposing
    ( deleteTag
    , removeTag
    , updateTagForm
...
import KMEditor.Editor2.KMEditor.Models.Editors exposing (Editor(..), KMEditorData, QuestionEditorData, TagEditorData, isTagEditorDirty, updateTagEditorData)
import KMEditor.Editor2.KMEditor.Models.Forms exposing (tagFormValidation)
import KMEditor.Editor2.KMEditor.Update.Abstract exposing (deleteEntity, updateForm, withGenerateEvent)
import KMEditor.Editor2.KMEditor.Update.Events exposing (createAddTagEvent, createDeleteTagEvent, createEditTagEvent)
import Msgs
