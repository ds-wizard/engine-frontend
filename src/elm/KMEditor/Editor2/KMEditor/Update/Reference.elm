module KMEditor.Editor2.KMEditor.Update.Reference exposing
    ( deleteReference
    , removeReference
    , updateIfQuestion
    , updateReferenceForm
...
import KMEditor.Editor2.KMEditor.Models.Editors exposing (Editor(..), QuestionEditorData, ReferenceEditorData, isReferenceEditorDirty, updateReferenceEditorData)
import KMEditor.Editor2.KMEditor.Models.Forms exposing (referenceFormValidation)
import KMEditor.Editor2.KMEditor.Update.Abstract exposing (deleteEntity, updateForm, withGenerateEvent)
import KMEditor.Editor2.KMEditor.Update.Events exposing (createAddReferenceEvent, createDeleteReferenceEvent, createEditReferenceEvent)
import Msgs
