module KMEditor.Editor.KMEditor.Update.Abstract exposing
    ( AddEntityConfig
    , DeleteEntityConfig
    , GenerateEventConfig
    , UpdateFormConfig
...
import KMEditor.Editor.KMEditor.Models.Editors exposing (Editor, EditorLike, EditorState(..), getNewState)
import Msgs
