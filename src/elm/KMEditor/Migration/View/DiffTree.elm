module KMEditor.Migration.View.DiffTree exposing (view)
...
import KMEditor.Common.KnowledgeModel.KnowledgeModel as KnowledgeModel exposing (KnowledgeModel, ParentMap)
