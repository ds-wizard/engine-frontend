...
l_ =
    l "KMEditor.Index.View"


lh_ : String -> List (Html msg) -> AppState -> List (Html msg)
lh_ =
    lh "KMEditor.Index.View"


lx_ : String -> AppState -> Html msg
lx_ =
    lx "KMEditor.Index.View"
                        ...
                        elem =
                            case packageIdToComponents forkOfPackageId of
                                Just ( orgId, kmId, version ) ->
                                    linkTo appState (Routes.KnowledgeModelsRoute <| KnowledgeModels.Routes.DetailRoute <| orgId ++ ":" ++ kmId ++ ":" ++ version)
