module KMEditor.Common.KnowledgeModel.Reference exposing
    ( Reference(..)
    , decoder
    , getUuid
    , getVisibleName
...
import KMEditor.Common.KnowledgeModel.Reference.CrossReferenceData as CrossReferenceData exposing (CrossReferenceData)
import KMEditor.Common.KnowledgeModel.Reference.ReferenceType as ReferenceType exposing (ReferenceType(..))
import KMEditor.Common.KnowledgeModel.Reference.ResourcePageReferenceData as ResourcePageReferenceData exposing (ResourcePageReferenceData)
import KMEditor.Common.KnowledgeModel.Reference.URLReferenceData as URLReferenceData exposing (URLReferenceData)
