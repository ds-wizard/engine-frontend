module KMEditor.Common.Events.Event exposing
    ( Event(..)
    , decoder
    , encode
    , getEntityUuid
...
import KMEditor.Common.Events.AddAnswerEventData as AddAnswerEventData exposing (AddAnswerEventData)
import KMEditor.Common.Events.AddChapterEventData as AddChapterEventData exposing (AddChapterEventData)
import KMEditor.Common.Events.AddExpertEventData as AddExpertEventData exposing (AddExpertEventData)
import KMEditor.Common.Events.AddIntegrationEventData as AddIntegrationEventData exposing (AddIntegrationEventData)
import KMEditor.Common.Events.AddKnowledgeModelEventData as AddKnowledgeModelEventData exposing (AddKnowledgeModelEventData)
import KMEditor.Common.Events.AddQuestionEventData as AddQuestionEventData exposing (AddQuestionEventData)
import KMEditor.Common.Events.AddReferenceEventData as AddReferenceEventData exposing (AddReferenceEventData)
import KMEditor.Common.Events.AddTagEventData as AddTagEventData exposing (AddTagEventData)
import KMEditor.Common.Events.CommonEventData as CommonEventData exposing (CommonEventData)
import KMEditor.Common.Events.EditAnswerEventData as EditAnswerEventData exposing (EditAnswerEventData)
import KMEditor.Common.Events.EditChapterEventData as EditChapterEventData exposing (EditChapterEventData)
import KMEditor.Common.Events.EditExpertEventData as EditExpertEventData exposing (EditExpertEventData)
import KMEditor.Common.Events.EditIntegrationEventData as EditIntegrationEventData exposing (EditIntegrationEventData)
import KMEditor.Common.Events.EditKnowledgeModelEventData as EditKnowledgeModelEventData exposing (EditKnowledgeModelEventData)
...
import KMEditor.Common.Events.EditTagEventData as EditTagEventData exposing (EditTagEventData)
