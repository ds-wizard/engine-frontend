...
formActions appState model =
    ...
    div [ class "form-actions" ]
        [ button [ class "btn btn-warning btn-wide", onClick RejectEvent, rejectDisabled, dataCy "km-migration_reject-button" ]
            [ rejectLabel ]
        , div []
            [ button [ class "btn btn-success btn-wide", onClick ApplyEvent, applyDisabled, dataCy "km-migration_apply-button" ]
                [ applyLabel ]
            , button [ class "btn btn-success btn-wide", onClick ApplyAll, applyAllDisabled, dataCy "km-migration_apply-all-button" ]
                [ applyAllLabel ]
            ]
        ]
