...
import Wizard.Pages.Locales.Common.LocaleCreateForm exposing (LocaleCreateForm)
...
view appState model =
        ...
        formView =
            Html.map FormMsg <|
                div []
                    ...
                    , FormGroup.input appState.locale model.form "description" <| gettext "Description" appState.locale
    ...
    in
    div [ detailClass "" ]
        [ Page.headerWithGuideLink (AppState.toGuideLinkConfig appState WizardGuideLinks.localesCreate) (gettext "Create Locale" appState.locale)
        , formView
