module Wizard.Pages.Projects.Detail.View exposing (view)
...
import Wizard.Pages.Projects.Detail.Documents.View as Documents
import Wizard.Pages.Projects.Detail.Files.View as Files
    ...
    case route of
        ...
        ProjectDetailRoute.Plugin pluginId ->
            ...
            case mbPluginData of
                ...
                Nothing ->
                    Page.error appState "Plugin not found"
