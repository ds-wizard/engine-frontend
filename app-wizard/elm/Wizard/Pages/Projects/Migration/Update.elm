module Wizard.Pages.Projects.Migration.Update exposing
    ( fetchData
    , update
    )
...
import Wizard.Pages.Projects.Migration.Models exposing (Model, initializeChangeList)
...
scrollToQuestion model =
    ...
    in
    model.selectedChange
        |> Maybe.map (QuestionChange.getQuestionUuid >> prefix >> Dom.scrollIntoView)
