...
update msg wrapMsg appState model =
    case msg of
        ...
        ExportDocumentTemplatePot documentTemplate ->
            ( model, Cmd.map (wrapMsg << FileDownloaderMsg) (FileDownloader.fetchFile (AppState.toServerInfo appState) (DocumentTemplatesApi.exportTemplatePotUrl documentTemplate.uuid)) )
