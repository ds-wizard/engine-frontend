module Wizard.Pages.Users.Edit.Components.SubmissionSettings exposing
    ( Model
    , Msg
    , UpdateConfig
    , fetchData
...
import Wizard.Pages.Users.Common.SubmissionPropsEditForm as SubmissionPropsEditForm exposing (SubmissionPropsEditForm)
