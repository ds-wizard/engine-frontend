module Wizard.Pages.DocumentTemplateEditors.Create.Update exposing
    ( fetchData
    , update
    )
...
update msg wrapMsg appState model =
    case msg of
        Cancel ->
            ( model, Window.historyBack (Routing.toUrl Routes.documentTemplateEditorsIndex) )
