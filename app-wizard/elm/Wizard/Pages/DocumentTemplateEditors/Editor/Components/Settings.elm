module Wizard.Pages.DocumentTemplateEditors.Editor.Components.Settings exposing
...
formViewKnowledgeModel appState model =
    ...
    Html.map FormMsg <|
        div []
            [ FormGroup.listWithHeader appState.locale allowedInputHeader allowedPackageFormView model.form "allowedPackages" (gettext "Allowed Knowledge Models" appState.locale) (gettext "Add knowledge model" appState.locale)
            ]
...
formViewFormats appState cfg model =
    div []
        [ FormGroup.listWithCustomMsg appState.locale FormMsg (formatFormView appState cfg) model.form "formats" (gettext "Formats" appState.locale) (gettext "Add format" appState.locale) ]
    ...
    div [ class "card bg-light mb-4" ]
        [ div [ class "card-body" ]
            ...
            , Html.map FormMsg <|
                div [ class "row" ]
                    [ div [ class "col" ]
                        [ FormGroup.input appState.locale form iconField (gettext "Icon" appState.locale) ]
                    , div [ class "col" ]
            ...
            , FormGroup.listWithCustomMsg appState.locale FormMsg (stepFormView appState cfg stepsField index) form stepsField (gettext "Steps" appState.locale) (gettext "Add step" appState.locale)
            ]
        ]
        ...
        [ div [ class "card-body" ]
            ...
            , Html.map FormMsg <|
                div [ class "input-table" ]
                    ...
                    , FormGroup.list appState.locale (stepOptionFormView appState optionsField) form optionsField "" (gettext "Add option" appState.locale)
                    ]
            ]
        ]
