module Wizard.Pages.DocumentTemplateEditors.Editor.Components.FileEditor exposing
    ( AssetCacheItem
    , Model
    , Msg
    , Selected
...
import Wizard.Components.CodeEditor as CodeEditor
import Wizard.Data.AppState exposing (AppState)
import Wizard.Pages.DocumentTemplateEditors.Editor.Components.FileEditor.AssetUploadModal as AssetUploadModal
import Wizard.Pages.DocumentTemplateEditors.Editor.Components.FileEditor.Editor as Editor exposing (Editor)
import Wizard.Pages.DocumentTemplateEditors.Editor.Components.FileEditor.EditorGroup as EditorGroup exposing (EditorGroup)
import Wizard.Pages.DocumentTemplateEditors.Editor.Components.FileEditor.FileTree as FileTree exposing (FileTree(..))
import Wizard.Pages.DocumentTemplateEditors.Editor.Components.FileEditor.MoveModal as MoveModal
import Wizard.Pages.DocumentTemplateEditors.Editor.Components.FileEditor.RenameModal as RenameModal
...
update cfg appState msg model =
    ...
    case msg of
        ...
        SetAddFileModalOpen open ->
            ( { model | addFileModalOpen = open, addFileModalFileName = "" }, Dom.focus "#file-name" )
        ...
        SetAddFolderModalOpen open ->
            ( { model | addFolderModalOpen = open, addFolderModalFolderName = "" }, Dom.focus "#folder-name" )
