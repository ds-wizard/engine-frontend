module Wizard.Api.Models.QuestionnaireDetail.Reply.ReplyValue exposing
    ( ReplyValue(..)
    , decoder
    , encode
    , getAnswerUuid
...
import Wizard.Api.Models.QuestionnaireDetail.Reply.ReplyValue.IntegrationReplyType as IntegrationReplyValue exposing (IntegrationReplyType(..))
