module Wizard.Components.Questionnaire.Components.VersionHistoryRightPanel exposing
    ( Model
    , Msg
    , ViewConfig
    , addEvent
...
import Wizard.Components.Questionnaire.Components.DeleteVersionModal as DeleteVersionModal
