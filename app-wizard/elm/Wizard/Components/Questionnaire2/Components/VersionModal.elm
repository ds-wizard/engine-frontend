module Wizard.Components.Questionnaire2.Components.VersionModal exposing
    ( Model
    , Msg
    , UpdateConfig
    , init
...
import Wizard.Components.Questionnaire2.VersionForm as VersionForm exposing (VersionForm)
