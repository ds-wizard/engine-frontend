module Wizard.Components.Questionnaire2.QuestionnaireRightPanel exposing
...
decoder : Decoder QuestionnaireRightPanel
decoder =
...
encode : QuestionnaireRightPanel -> E.Value
encode rightPanel =
    case rightPanel of
        None ->
            E.object
...
commentsOpen : String -> QuestionnaireRightPanel -> Bool
commentsOpen path rightPanel =
    case rightPanel of
        Comments p ->
            p == path
