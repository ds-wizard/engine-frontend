module Wizard.Common.Components.Questionnaire.SummaryReport exposing
    ( Context
    , Model
    , Msg
    , fetchData
...
l_ =
    l "Wizard.Common.Components.Questionnaire.SummaryReport"


lf_ : String -> List String -> AppState -> String
lf_ =
    lf "Wizard.Common.Components.Questionnaire.SummaryReport"


lx_ : String -> AppState -> Html msg
lx_ =
    lx "Wizard.Common.Components.Questionnaire.SummaryReport"
