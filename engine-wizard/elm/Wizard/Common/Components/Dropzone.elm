module Wizard.Common.Components.Dropzone exposing
    ( DropzoneConfig
    , Msg
    , State
    , UpdateConfig
...
viewDropzone cfg state =
    div
        ...
        , alwaysPreventDefaultOn "dragenter" (D.succeed (cfg.wrapMsg DragEnter))
        , alwaysPreventDefaultOn "dragover" (D.succeed (cfg.wrapMsg DragEnter))
        , alwaysPreventDefaultOn "dragleave" (D.succeed (cfg.wrapMsg DragLeave))
        , alwaysPreventDefaultOn "drop" (dropDecoder cfg)
        ]
