    ...
    Dict.fromList
        (SharedIconSet.iconSet
            ++ [ ( "_global.add", "fas fa-plus" )
               ...
               , ( "menu.devOperations", "fas fa-terminal" )
               ...
               , ( "menu.persistentCommands", "fas fa-database" )
               , ( "menu.profile", "fas fa-user-edit" )
               , ( "menu.projectImporters", "fas fa-file-import" )
               ...
               , ( "questionnaireImporter.disable", "fas fa-toggle-off" )
               , ( "questionnaireImporter.enable", "fas fa-toggle-on" )
