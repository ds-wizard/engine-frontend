module Wizard.DocumentTemplates.Import.FileImport.Update exposing (update)
...
handleSubmit wrapMsg appState model =
    case model.file of
        Just file ->
            ...
            , Cmd.map wrapMsg <| DocumentTemplatesApi.importTemplate file appState ImportTemplateCompleted
            )
