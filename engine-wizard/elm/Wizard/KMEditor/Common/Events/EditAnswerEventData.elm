module Wizard.KMEditor.Common.Events.EditAnswerEventData exposing
    ( EditAnswerEventData
    , decoder
    , encode
    )
...
import Wizard.KMEditor.Common.KnowledgeModel.MetricMeasure as MetricMeasure exposing (MetricMeasure)
