module Wizard.KMEditor.Common.KnowledgeModel.Reference exposing
    ( Reference(..)
    , decoder
    , getUuid
    , getVisibleName
...
import Wizard.KMEditor.Common.KnowledgeModel.Reference.CrossReferenceData as CrossReferenceData exposing (CrossReferenceData)
import Wizard.KMEditor.Common.KnowledgeModel.Reference.ReferenceType as ReferenceType exposing (ReferenceType(..))
import Wizard.KMEditor.Common.KnowledgeModel.Reference.ResourcePageReferenceData as ResourcePageReferenceData exposing (ResourcePageReferenceData)
import Wizard.KMEditor.Common.KnowledgeModel.Reference.URLReferenceData as URLReferenceData exposing (URLReferenceData)
