...
initialModel appState =
    ...
    , indexModel = Wizard.Projects.Index.Models.initialModel PaginationQueryString.empty Nothing Nothing Nothing
...
initLocalModel appState route model =
    case route of
        ...
        IndexRoute paginationQueryString mbIsTemplate mbUser mbProjectTags ->
            { model | indexModel = Wizard.Projects.Index.Models.initialModel paginationQueryString mbIsTemplate mbUser mbProjectTags }
