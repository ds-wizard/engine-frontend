...
type alias EditIntegrationApiEventData =
    ...
    , testVariables : EventField (List KeyValuePair)
...
decoder =
    D.succeed EditIntegrationApiEventData
        ...
        |> D.required "testVariables" (EventField.decoder (D.list KeyValuePair.decoder))
...
encode data =
    ...
    , ( "testVariables", EventField.encode (E.list KeyValuePair.encode) data.testVariables )
