module Wizard.Questionnaires.Detail.Components.QuestionnaireSaving exposing
    ( Model
    , Msg
    , init
    , setSaved
...
l_ =
    l "Wizard.Questionnaires.Detail.Components.QuestionnaireSaving"


lx_ : String -> AppState -> Html msg
lx_ =
    lx "Wizard.Questionnaires.Detail.Components.QuestionnaireSaving"
