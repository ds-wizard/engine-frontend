...
locale =
    Dict.fromList
        ...
        , ( "Registry.Pages.Organization.update.putSuccess", "Your changes has been saved." )
        ...
        , ( "Registry.Pages.Signup.success.heading", "Sign up successful!" )
        , ( "Registry.Pages.Signup.success.msg", "Check your email address for the activation link." )
        , ( "Registry.Pages.Signup.formView.privacyRead", "I have read %h and %h." )
        ...
        , ( "Registry.Pages.TemplateDetail.update.getError", "Unable to get template." )
