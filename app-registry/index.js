...
function bootstrapErrorHTML(errorCode) {
    ...
    return '<div class="page-illustrated-message"><img src="/assets/illustrations/undraw_bug_fixing.svg"><div><h1>' + title + '</h1><p>' + message + '<br>Please, contact the application provider.</p></div></div>'
}
