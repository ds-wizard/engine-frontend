module KMEditor.Common.KnowledgeModel.KnowledgeModelEntitiesTest exposing (knowledgeModelEntitiesDecoderTest)

import Dict
import KMEditor.Common.KnowledgeModel.KnowledgeModelEntities as KnowledgeModelEntities
