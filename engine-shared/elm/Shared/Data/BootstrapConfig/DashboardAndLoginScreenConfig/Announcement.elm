module Shared.Data.BootstrapConfig.DashboardAndLoginScreenConfig.Announcement exposing
    ( Announcement
    , decoder
    , encode
    , toFormInitials
...
import Shared.Data.BootstrapConfig.DashboardAndLoginScreenConfig.Announcement.AnnouncementLevel as AnnouncementLevel exposing (AnnouncementLevel)
