module Shared.Components.AIAssistant exposing
    ( Msg
    , State
    , UpdateConfig
    , ViewConfig
...
import Shared.Components.AIAssistant.Api as Api
import Shared.Components.AIAssistant.Models.Answer exposing (Answer)
import Shared.Components.AIAssistant.Models.Conversation exposing (Conversation)
import Shared.Components.AIAssistant.Models.Message exposing (Message)
...
view cfg (State state) =
    ActionResultBlock.view
        { viewContent = viewConversation cfg state
        , actionResult = state.conversation
        , locale = cfg.locale
        }
