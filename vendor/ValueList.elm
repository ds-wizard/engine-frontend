...
view valueList =
    div []
        [ div [ class "input-group" ]
            [ input [ class "form-control", type_ "text", onInput Input, value valueList.current ] []
            , div [ class "input-group-append" ]
                [ button [ class "btn btn-secondary", onClick Add ] [ text "Add" ]
                ]
            ]
...
viewItem index title =
    li [ class "list-group-item d-flex justify-content-between align-items-center" ]
        [ text title
        , a [ class "text-danger", onClick <| RemoveAt index ]
