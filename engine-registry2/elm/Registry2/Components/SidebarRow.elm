module Registry2.Components.SidebarRow exposing (ViewIdProps, ViewOtherVersionsProps, ViewProps, view, viewId, viewLicense, viewMetamodelVersion, viewOrganization, viewOtherVersions, viewPublishedOn, viewVersion)
