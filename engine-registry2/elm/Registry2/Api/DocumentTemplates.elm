module Registry2.Api.DocumentTemplates exposing (getDocumentTemplate, getDocumentTemplates)

import Json.Decode as D
import Registry2.Api.Models.DocumentTemplate as DocumentTemplate exposing (DocumentTemplate)
import Registry2.Api.Models.DocumentTemplateDetail as DocumentTemplateDetail exposing (DocumentTemplateDetail)
